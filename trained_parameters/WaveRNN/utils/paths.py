...
class Paths:
    def __init__(self, data_path, voc_id, tts_id, out_dir):
        # Data Paths
        ...
        self.voc_checkpoints = f'{out_dir}/checkpoints/{voc_id}.wavernn/'
        self.voc_latest_weights = f'{self.voc_checkpoints}latest_weights.pyt'
        self.voc_output = f'{out_dir}/model_outputs/{voc_id}.wavernn/'
        self.voc_step = f'{self.voc_checkpoints}/step.npy'
        self.voc_log = f'{self.voc_checkpoints}log.txt'
        # Tactron/TTS Paths
        self.tts_checkpoints = f'{out_dir}/checkpoints/{tts_id}.tacotron/'
        self.tts_latest_weights = f'{self.tts_checkpoints}latest_weights.pyt'
        self.tts_output = f'{out_dir}/model_outputs/{tts_id}.tts/'
